...
$spesialisasi = isset($_POST["id_spesialisasi"])?$_POST["id_spesialisasi"]:null;
	...
	_update("update penduduk set jenis_kelamin='$jKelamin',sip='$noSIP' where id='$id_penduduk'");
	_update("update dinamis_penduduk set alamat_jalan = '$address', id_kelurahan = $idKel, id_profesi = '2', id_agama = $agama where id_penduduk = '$id_penduduk' and akhir = '1'");
