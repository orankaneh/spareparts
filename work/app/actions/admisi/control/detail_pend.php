...
if (isset($_POST['add'])) {
	...
	if ($sql) {
		header("location: ".app_base_url('admisi/detail-pend')."?id=$idPenduduk&msg=1");
	}
}
...
<?php
    ...
    $data = $penduduk;
    delete_list_data($_GET['id'], 'dinamis_penduduk', 'admisi/detail-pend?id='.$_GET['id'].'&msg=2','admisi/detail-pend?id='.$_GET['id'].'&msr=8'," dinamis penduduk ".$data['nama']);
}
?>
