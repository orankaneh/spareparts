...
$sql= "
    ...
    WHERE kelas.id='1' and  date(kj.waktu)>='".date2mysql($startDate)."' and date(kj.waktu)<='".date2mysql($endDate)."'
";
//echo $sql;
...
$content.=app_core_render(APP_APP_PATH.'/views/gridKunjungan/table.php', array('gridData' => $gridData));
echo app_core_render(APP_APP_PATH.'/views/report.php',array(
            'content'=>$content,
            'title'=>'LAPORAN'
        ));
//echo app_core_render(APP_APP_PATH.'/views/gridKunjungan/report.php', array(
//    'pageTitle' => $PAGE_TITLE,
//    'baseURL' => $baseURL,
//    'gridData' => $gridData,
//    'tableTitle'=> 'Daftar Pasien'
//    ));
