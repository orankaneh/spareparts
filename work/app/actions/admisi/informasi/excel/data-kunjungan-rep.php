...
header_excel("kunjungan-pasien.xls");
set_time_zone();
...
?>
<table>
    <tr><td colspan="9" align="center">LAPORAN KUNJUNGAN PASIEN</td></tr>
    <tr><td colspan="9" align="center">Periode <?= indo_tgl(datefmysql($startDate))." s.d ".  indo_tgl(datefmysql($endDate))?></td></tr>
</table>
<div class="data-list">
