...
<fieldset class="field-group"><legend>Bulanan</legend>
    <div class="monthly-selector">
        ...
        <input type=button class="prev-month-button" name="previousthawal" VALUE="" onClick="setPreviousbln1()">
                     <select name="bln1" id="bln1"onChange="selectDate()" class="month">
                ...
                <input name="thawal" id="thawal" type=TEXT SIZE=4 MAXLENGTH=4 value="<? echo date("Y"); ?>" class="year">
        ...
        <input type=button name="previousthakhir" class="prev-month-button" VALUE="" onClick="setPreviousbln2()">
            <select name="bln2" id="bln2" onChange="selectDate()" class="month">
                    <option value="Januari">January</option>
                    <option value="Februari">February</option>
                    <option value="Maret">March</option>
                    <option value="April">April</option>
            ...
            <input name="thakhir" id="thakhir" type=TEXT SIZE=4 MAXLENGTH=4 value="<? echo date("Y"); ?>" class="year">
    ...
    <fieldset class="field-group" style="white-space:normal">
			...
			<input name="awal" id="awal" type=text size=4 maxlength=4 class="year" onkeyup="Angka(this)" value="<? echo date("Y");?>">
			...
			<input name="akhir" id="akhir" type=text size=4 maxlength=4 class="year" onkeyup="Angka(this)" value="<? echo date("Y");?>">
