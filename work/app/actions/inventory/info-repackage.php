...
$(function() {
        $('#barang').autocomplete("<?= app_base_url('/inventory/search?opsi=namabarang') ?>",
        {
            ...
            function(event,data,formated){
               $(this).attr('value',data.nama_barang+' '+data.nilai_konversi+' '+data.satuan_terkecil);
        ...
        $('#display').click(function () {
            ...
            $.ajax({
                url: "<?= app_base_url('inventory/info-repackage-table') ?>",
                cache: false,
...
<h2 class="judul">Informasi Repackage Barang</h2><?= isset($pesan) ? $pesan : NULL ?>
<div class="data-input">
    ...
    <form action="" method="GET">
            ...
            <fieldset class="input-process">
                ...
                <input type="button" value="Batal" class="tombol" onClick="javascript:location.href='<?= app_base_url('inventory/info-repackage') ?>'"/>
            </fieldset>
    </form>    
</fieldset>
</div>
