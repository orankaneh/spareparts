...
<fieldset><legend>Detail Laporan Stok</legend>
    <div class="data-list">
        <table class="tabel">
            ...
            <?php
                $stok = stok_obat_unit_muat_data($startDate, $endDate, $packing, null, $perundangan, $generik, $indikasi, $ven, $ssf, $formularium);
...
<?php endforeach; ?>
            ...
            <a href="<?= app_base_url('inventory/report/stok-barang-excel/?startDate=' . $startDate . '&endDate=' . $endDate . '&packing=' . $packing . '&jenisTransaksi=' . $jenisTransaksi . '') ?>" class="excel">Cetak Excel</a>
        </fieldset><br/>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(".cetak").click(function(){
                    var win = window.open('report/stok-barang?startDate=<?= $startDate ?>&endDate=<?= $endDate ?>&packing=<?= $packing ?>&jenisTransaksi=<?= $jenisTransaksi ?>', 'MyWindow', 'width=800px,height=600px,scrollbars=1');
        })
    })
</script>    