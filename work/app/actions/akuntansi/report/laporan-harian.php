...
require_once "app/lib/common/master-akuntansi.php";
	...
	?>
	<center><h1 class="judul">Pendapatan  <?php echo $profil['nama'] ;?><br>
	<span style='font-size: 14px'>per-Tanggal : <?php echo $array_tanggal[2]." ".bulan($array_tanggal[1])." ".$array_tanggal[0]; ?></span></h1></center>
	<fieldset><legend>Laporan Pendapatan </legend>
	<table class='data-list w700px' >
		...
		<div class="floleft data-list">
			<?php 	echo excelButton("akuntansi/excel/laporan-harian?cetak=1&tanggal=".$_GET["tanggal"]."&section=N",'Cetak Excel');?>
		</div>
	</table>
	</fieldset>
	<?php
